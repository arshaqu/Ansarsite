...
function Testimonials() {
  ...
  return (
    <div
      ...
      <div
        ...
        {/* Box 1 */}
        <div
  className={`lg:h-[580px] boxe transition-all duration-700 ${
  ...
  style={{
    ...
    overflow: 'hidden',
    padding: '20px',
    position: 'relative', // Added for proper placement
  }}
  onMouseEnter={(e) => {
    e.currentTarget.style.transform = 'scale(1.08) translateY(-22px)';
  }}
  onMouseLeave={(e) => {
...
>
  ...
  <p style={{ color: '#272F3F' }} className="m-5 montserrat">
    Ansar's coaching has transformed our sales team, enhancing performance and fostering growth. His journey is truly inspiring, motivating others to overcome challenges with resilience. His insights have had a profound impact, pushing us to excel. I am now more driven to pursue my dreams with renewed energy and determination.
        ...
        {/* Box 2 */}
        <div
          className={ `lg:h-[510px] boxe mt-2.5 transition-all duration-700 delay-100 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20 '
          }`}
          style={{
            fontFamily: 'cursive',
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.08) translateY(-19px)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1) translateY(0)';
          }}
        ...
        {/* Box 3 */}
        <div
          className={`lg:h-[440px] boxe mt-2.5 transition-all duration-700 delay-200 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20 '
          }`}
          style={{
            fontFamily: 'cursive',
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.07) translateY(-14px)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1) translateY(0)';
          }}
        ...
        {/* Box 4 */}
        <div
          className={ `lg:h-[530px] boxe mt-2.5 transition-all duration-700 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
          style={{
            fontFamily: 'cursive',
