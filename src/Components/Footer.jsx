  ...
  return (
    ...
    <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-10">
      ...
      <div className="flex-1 min-w-[200px]">
        <h3 className="text-emerald-500 text-xl font-medium mb-4 montserrat cursor-pointer text-center sm:text-left">My Services</h3>
      ...
      {/* Services Section */}
      <div className="flex-1 min-w-[200px]">
        <h3 className="text-emerald-500 text-xl font-medium mb-4 montserrat cursor-pointer text-center sm:text-left">Quick Links</h3>
        <ul className="space-y-2 text-center sm:text-left">
      ...
      <div className="flex-1 min-w-[250px]">
        <h3 className="text-emerald-500 text-xl font-medium mb-4 montserrat text-center sm:text-left">News Letter</h3>
        <p className="text-gray-600 text-sm hover:text-emerald-600 cursor-pointer text-center sm:text-left">
      ...
      <div className="flex-1 min-w-[250px] sm:text-center md:text-left">
        {/* Logo - Hidden on small screens, centered on small screens */}
        <div className="mb-6 hidden sm:block sm:flex sm:justify-center md:block md:justify-start">
          <img 
            src={sign}
        ...
        {/* Company Description */}
        <p className="text-sm text-blue-900 mb-4 text-center sm:text-left">
          Follow Me On  -
        </p>
        ...
        <div className="flex gap-4 justify-center sm:justify-center md:justify-start">
            {Object.keys(socialIcons).map((social) => (
              <div
                key={social}
                className="w-10 h-10 bg-blue-900 rounded-lg flex items-center justify-center hover:bg-blue-300 transition-colors"
              >
                {socialIcons[social]}
              </div>
            ))}
